...
export default function VendingAdminPage() {
  ...
  if (!isAdmin) {
    return (
      <div className="bg-pop-pink min-h-dvh pt-28 pb-20">
        <div className={`${container} max-w-xl`}>
          <div className={submitGate}>
            <div className={submitGateIcon}>🔒</div>
            <h2 className={submitGateH2}>Admins only</h2>
            <p className={submitGateP}>
              Sign in with an admin account to manage the vending machine.
            </p>
          </div>
        </div>
      </div>
  ...
  return (
    <div className="bg-pop-pink min-h-dvh pb-24">
      <div className="pt-20">
        <div className={pageBand}>
          <p className={`${pageBandTitle} text-pop-pink`}>Vending Admin</p>
        </div>
      </div>
