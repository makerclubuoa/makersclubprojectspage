          ...
          <div className="footer__main-inner">
            ...
            <div className="footer__brand">
              ...
              <div className="footer__socials">
                <a href="https://www.instagram.com/make.uoa/" target="_blank" rel="noopener noreferrer" aria-label="Instagram">
                ...
                <a href="https://discord.gg/6NFXUU2euN" target="_blank" rel="noopener noreferrer" aria-label="Discord">
                ...
                <a href="https://www.facebook.com/makeuoa" target="_blank" rel="noopener noreferrer" aria-label="Facebook">
            ...
            <div className="footer__nav">
              <div className="footer__nav-group">
                <h5>Club</h5>
                <ul>
                  <li><a href="https://makeuoa.nz/about/">About</a></li>
                  <li><a href="https://makeuoa.nz/tag/updates/">Updates</a></li>
                  <li><a href="https://makeuoa.nz/code-of-conduct/">Code of Conduct</a></li>
                  <li><a href="https://discord.gg/6NFXUU2euN">Discord</a></li>
                  <li><a href="https://vend.makeuoa.nz/">Vending Machine</a></li>
                </ul>
              </div>
              <div className="footer__nav-group">
                <h5>Projects</h5>
                <ul>
                  ...
                  <li><Link href="/submit">Submit a project</Link></li>
