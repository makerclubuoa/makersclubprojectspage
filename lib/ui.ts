...
export const secHeadRow = 'flex items-baseline justify-between gap-x-4 gap-y-1 flex-wrap'
...
export const btnGradient = `${btn} bg-pop-pink text-white hover:opacity-90`
...
export const typepickBtnOn = 'bg-black text-white shadow-[2px_2px_0px_0px_#000]'
...
export const emptyStateMono = 'text-[12px] font-bold tracking-[0.1em] uppercase'
...
export const dynRowMilestoneInput = 'w-auto border-2 border-black px-1 py-0.5 cursor-pointer accent-pop-magenta'
export const dynAdd =
...
export const galleryThumb = 'relative aspect-[4/3] overflow-hidden border-2 border-black rounded-[6px]'
...
export const submitNoticeConsentInput = 'mt-0.5 shrink-0 w-auto accent-pop-magenta'
export const submitNoticeConsentSpan = 'flex flex-col gap-0.5 text-[13px] font-semibold text-ink'
